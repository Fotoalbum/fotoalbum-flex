package classes
{
	...
	public class ModuleMarshaller extends EventDispatcher
	{
		...
		protected function progressHandler(event:ProgressEvent):void {
			...
			//trace("Progress: " + event.bytesLoaded +  " from: " + event.bytesTotal);	
			//if (FlexGlobals.topLevelApplication.fontloaderpopup) {
				//FlexGlobals.topLevelApplication.fontloaderpopup.progressBar.minimum = 12;
				//FlexGlobals.topLevelApplication.fontloaderpopup.progressBar.maximum = event.bytesTotal;
				//FlexGlobals.topLevelApplication.fontloaderpopup.progressBar.setProgress(event.bytesLoaded, event.bytesTotal);
				//trace("Progress: " + event.bytesLoaded + " from: " + event.bytesTotal);
				//FlexGlobals.topLevelApplication.fontloaderpopup.progressBar.invalidateDisplayList();
				//FlexGlobals.topLevelApplication.fontloaderpopup.progressBar.validateNow();
		...
		protected function errorHandler(event:Event):void
		{
			...
			{
				Alert.show(ErrorEvent(event).text);
