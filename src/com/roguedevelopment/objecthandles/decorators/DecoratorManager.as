package com.roguedevelopment.objecthandles.decorators
{
	...
	{
		protected var drawLayer:Group;
		protected var decorators:Array = [];
		protected var subDrawLayers:Object = {};
		protected var objectHandles:ObjectHandles;
		
		public function DecoratorManager(objectHandles:ObjectHandles, drawLayer:Group)
		{
		...
		{
			var subDrawLayer:Group = new Group();
			drawLayer.addElement(subDrawLayer);
